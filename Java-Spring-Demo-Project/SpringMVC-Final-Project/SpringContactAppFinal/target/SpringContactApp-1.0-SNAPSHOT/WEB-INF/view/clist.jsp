<%-- 
    Document   : clist
    Created on : Jul 17, 2018, 2:05:55 PM
    Author     : osmanForhad
--%>
...
<html>
    <head>
        ...
        <title>Contact List - Spring Contact Application</title>
            ...
            <tr>
                <td height="350px" valign="top">
                    ...
                    <c:if test="${param.act eq 'sv'}">
                        <p align="center" class="success">Contact Saved Successfully</p>
                    </c:if>
                    <c:if test="${param.act eq 'del'}">
                        <p align="center" class="success">Contact Deleted Successfully</p>
                    </c:if>
                    <c:if test="${param.act eq 'ed'}">
                        <p align="center" class="success">Contact Update Successfully</p>
                    </c:if>
